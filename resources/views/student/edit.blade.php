    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row justify-content-md-center">
          <div class="col-md-6">
            <form action="{{route('student.update',['id'=>$student->id])}}" method="POST" autocomplete="off">
               @csrf
              <div class="row">
                <div class="col">
                  ...
                  name="last_name" value="{{old('last_name') ? old('last_name') : $student->last_name}}">
                  @error('last_name')
                ...
                <div class="col">
                  ...
                  name="first_name" value="{{old('first_name') ? old('last_name') : $student->first_name}}">
                  @error('first_name')
                    <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>  
              ...
              <div class="row">
                ...
                <div class="col">
                  ...
                  <select name="id_class" id="id_class" class="form-control @error('id_class') is-invalid @enderror">
                    ...
                    {{$student->id_class == $classGrade->id ? 'selected' : ''}}>{{$classGrade->class_grade}}</option>
                    @endforeach
                  </select>
                  @error('id_class')
                    <div class="text-danger">{{ $message }}</div>
              ...
              <div class="form-group">
                ...
                class="form-control @error('date_of_birth') is-invalid @enderror"
                 name="date_of_birth" value="{{old('date_of_birth') ? old('date_of_birth') : $student->date_of_birth}}">
                @error('date_of_birth')
                    <div class="text-danger">{{ $message }}</div>
                  @enderror
              </div>
                <div class="form-group">
                  ...
                  name="address" value="{{old('address') ? old('last_name') : $student->address}}">
                  @error('address')
                    <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>  

    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row justify-content-md-center">
          <div class="col-md-6">
            <form action="{{route('student.transcript-store',['id'=>$idStudent,'grade'=>$idGradeStudent])}}" method="POST" autocomplete="off">
               @csrf
               <div class="form-row">
                   <div class="form-group col-md-6">
                        ...
                        <select name="id_semester" id="id_semester" class="form-control @error('id_semester') is-invalid @enderror">
                            ...
                            @foreach($semesters as $semester)
                                <option value="{{$semester->id}}" {{old('id_semester') == $semester->id ? 'selected' : ''}}>{{$semester->semester}}</option>
                            @endforeach
                        </select>
                        @error('id_semester')
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="id_school_year" id="id_schoo_year" class="form-control @error('id_school_year') is-invalid @enderror">
                            ...
                            @foreach($schoolYears as $schoolYear)
                                <option value="{{$schoolYear->id}}" {{old('id_school_year') == $schoolYear->id ? 'selected' : ''}}>{{$schoolYear->school_year}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-row mt-4">
                    <div class="form-group col-md-4">
                        ...
                        value="{{old('gpa_math')}}" id="gpa_math" name="gpa_math" placeholder="8" step="any" >
                        @error('gpa_math')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        value="{{old('gpa_literature')}}" id="gpa_literature" step="any" name="gpa_literature" placeholder="8">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        value="{{old('gpa_english')}}" id="gpa_english" step="any" name="gpa_english" placeholder="8">
                        @error('gpa_english')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row mt-4">
                    <div class="form-group col-md-4">
                        ...
                        value="{{old('gpa_physics')}}"id="gpa_physics" step="any" name="gpa_physics" placeholder="8">
                        @error('gpa_physics')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        value="{{old('gpa_chemistry')}}" id="gpa_chemistry" step="any" name="gpa_chemistry" placeholder="8">
                        @error('gpa_chemistry')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        value="{{old('gpa_biology')}}" id="gpa_biology"  step="any" name="gpa_biology" placeholder="8">
                        @error('gpa_biology')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row mt-4">
                    <div class="form-group col-md-4">
                        ...
                        value="{{old('gpa_history')}}"id="gpa_history" step="any" name="gpa_history" placeholder="8">
                        @error('gpa_history')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        value="{{old('gpa_geography')}}"id="gpa_geography" step="any" name="gpa_geography" placeholder="8">
                        @error('gpa_geography')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        value="{{old('gpa_technology')}}"id="gpa_technology" step="any" name="gpa_technology" placeholder="8">
                ...
                <div class="form-row mt-4">
                    <div class="form-group col-md-3">
                        ...
                        value="{{old('gpa_informatics')}}"id="gpa_informatics" step="any" name="gpa_informatics" placeholder="8">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        value="{{old('gpa_civic_education')}}"id="gpa_civic_education" step="any" name="gpa_civic_education" placeholder="8">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        value="{{old('gpa_national_defense_education')}}" step="any" id="gpa_national_defense_education" name="gpa_national_defense_education" placeholder="8">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="gpa_physical_education" id="gpa_physical_education" class="form-control @error('gpa_physical_education') is-invalid @enderror">
                            ...
                            <option value="Đ" {{old('gpa_physical_education') == 'Đ' ? 'selected' : ''}}>Đạt</option>
                            <option value="KĐ" {{old('gpa_physical_education') == 'KĐ' ? 'selected' : ''}}>Không đạt</option>
                        </select>
                        @error('gpa_physical_education')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
